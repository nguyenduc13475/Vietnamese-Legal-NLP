...
\begin{itemize}
    ...
    \item \textbf{HuggingFace Transformers \& PyTorch:} Nền tảng cốt lõi để tải, tinh chỉnh (fine-tune) và thực suy diễn (inference) mô hình PhoBERT. Khung PyTorch cho phép tùy biến sâu các hàm mất mát (như \textit{Focal Loss}) và kiến trúc mạng học sâu bổ sung (như \textit{BiLSTM} cho tác vụ SRL).
